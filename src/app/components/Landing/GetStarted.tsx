        ...
        <div className="lg:min-h-[740px] flex flex-col justify-center mt-36 w-full pb-10 lg:pb-0">
          <div className="flex flex-col-reverse lg:flex-row justify-between items-center">
            <div className="w-full lg:max-w-lg flex flex-col gap-6">
              ...
              <Button className="bg-[var(--dark-background-color)] hover:bg-[var(--dark-background-color)] w-fit px-0 py-0">
            ...
            <div className="lg:w-full max-w-2xl relative lg:left-20 overflow-hidden">
              <Image src={"/assets/thumbnail.png"} className="relative w-[300px] lg:w-fit top-20 lg:left-0 dark:shadow-custom-white dark:bg-transparent" alt="" width={500} height={500}/>
              <Image src={"/assets/thumbnail_1.png"} className="relative -top-20 lg:-top-28 left-8 lg:left-14" alt="" width={500} height={500}/>
            </div>
          </div>
        </div>
      </Container>
